class JogoDaMemoria {
  constructor({ tela, util }) {
    ...
    this.iconePadrao = "./images/interrogation.png";
    this.heroisIniciais = [
      { img: "./images/batman.png", nome: "batman" },
      { img: "./images/spider-man.png", nome: "homem aranha" },
      { img: "./images/wonder-woman.png", nome: "mulher maravilha" },
      { img: "./images/capitain-america.png", nome: "capitao america" },
      { img: "./images/ironman.png", nome: "homem de ferro" },
      { img: "./images/superman.png", nome: "superman" },
      { img: "./images/flash.png", nome: "flash" },
    ];
